...
const Cover = ({ bgImg, title, text }) => {
  return (
    // <div
    //     className="relative lg:mt-1 mx-auto bg-no-repeat bg-cover h-[600px]"
    //     style={{
    //       backgroundImage: `url("${bgImg}")`,
    //     }}
    //   >
    //     <div className="absolute top-16 left-52 text-center text-neutral-content px-10 py-8  md:px-28 md:py-16 lg:px-40 lg:py-20 bg-black bg-opacity-50">
    //       <div className="max-w-md">
    //         <h1 className="mb-5 text-3xl md:text-4xl lg:text-6xl font-bold text-white">
    //           {title}
    //         </h1>
    //         <p className="mb-5 text-xs md:text-sm lg:text-lg uppercase text-white">{text}</p>
    //       </div>
    //     </div>
    //   </div>
