...
const AppliedJobs = () => {
  ...
  return (
    <div className="px-10 py-6 bg-gray-100 min-h-screen flex flex-col">
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {appliedJobs?.slice(startIndex, endIndex)?.map((singleJob) => (
                <tr key={singleJob._id}>
                  <td className="ps-10">
                  <img
                        src={singleJob.appliedjobdata.image}
                        alt="Job"
                    ...
                    <div className="flex ps-9  items-center">
                      <div>
                        <p className="font-semibold text-base md:text-lg">
                          {singleJob.appliedjobdata.companyName}
                        </p>
                  ...
                  <td className="text-gray-600  font-semibold">  {singleJob.appliedjobdata.title}</td>
                  <td className="py-2 md:py-4"> August 30, 2023</td>
                  <td className="py-2 md:py-4">
      ...
      © Biomed 2023. All rights reserved.
      </div>
    </div>
  );
};
