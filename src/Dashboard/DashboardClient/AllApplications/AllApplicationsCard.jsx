        ...
        <div className='mt-4 lg:mt-0 md:mt-2'>
            ...
            <div className='lg:flex'>
                ...
                <div className='flex gap-4 lg:ms-16 md:my-3 my-3'>
                    ...
                    <button className='dark:bg-slate-700 dark:text-white bg-[#F0F5F7] hover:bg-[#1967D2] hover:text-white w-8 h-8 rounded-lg text-[#1967d2] flex justify-center items-center'><AiOutlineCheck size={18}/></button>
                    <button className='dark:bg-slate-700 dark:text-white bg-[#F0F5F7] hover:bg-[#1967D2] hover:text-white w-8 h-8 rounded-lg text-[#1967d2] flex justify-center items-center'><RxCrossCircled size={18}/></button>
            ...
            <div className='flex text-sm lg:gap-16 md:gap-10 gap-8 md:mt-2 mt-6 mb-1 md:mb-0'>
                <div className='p-2 rounded-lg dark:bg-slate-700 bg-[#F0F5F7]'><p className='dark:text-white text-[#696969]'>{tags[0]}</p></div>
                <div className='p-2 rounded-lg dark:bg-slate-700 bg-[#F0F5F7]'><p className='dark:text-white text-[#696969]'>{tags[1]}</p></div>
                <div className='p-2 rounded-lg dark:bg-slate-700  bg-[#F0F5F7]'><p className='dark:text-white text-[#696969]'>{tags[2]}</p></div>
            </div>
        </div>
    </div>
    );
