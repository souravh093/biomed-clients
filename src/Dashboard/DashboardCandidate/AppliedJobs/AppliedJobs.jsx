            ...
            <div className="bg-white shadow-md p-8 mx-10 rounded-2xl">
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-gray-50">
                        <tr>
                            <th className="py-3 text-left text-lg">Job title</th>
                            <th className="py-3 text-left text-lg">Date applied</th>
                            <th className="py-3 text-left text-lg">Status</th>
                            <th className="py-3 text-left text-lg">Action</th>
                        </tr>
                    </thead>
                        ...
                        <tr>
                            <td className="py-4">
                                <div className="flex items-center">
                                    ...
                                    />
                                    <div>
                                        <p className="font-semibold text-lg">Software Engineer, Android, Libraries</p>
                                        <div className="flex mt-1 text-gray-600">
                                            <FaBriefcase className="w-4 h-4 mr-1" /> <p>Segment</p>
